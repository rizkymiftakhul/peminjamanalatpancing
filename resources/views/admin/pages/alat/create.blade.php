...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ auth()->user()->role === 'petugas' ? route('petugas.alat.store') : route('admin.alat.store') }}" 
              method="POST" 
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ auth()->user()->role === 'petugas' ? route('petugas.alat.index') : route('admin.alat.index') }}" 
